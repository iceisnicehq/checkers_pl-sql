...
-- 4. PLAYER_RATINGS (REMOVED wins, losses, draws)
CREATE TABLE player_ratings (
    ...
    matches_played   INT DEFAULT 0 NOT NULL, -- KEEPING matches_played for total activity count
...
-- 7. GAME_MOVES (REMOVED player_id)
