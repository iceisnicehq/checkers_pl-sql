...
-- 
-- 2. Наполнение базы данных (папка tables/):
--    - Выполнить файлы наполнения после создания всех таблиц:
--      * 13_insert_game_rules.sql - наполнение правилами игры (после 02_game_rules.sql)
--      * 14_insert_seasons.sql - создание начального сезона (после 03_seasons.sql)
