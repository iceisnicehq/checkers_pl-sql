...
-- 5
    INSERT INTO puzzles (board_position, turn_to_move, moves_to_solve, difficulty_level, created_by_player_id, rule_id, solution)
    VALUES ('16b1b4b1b6b1b3b4b6w1b1w1w4w3w1w6w6w5w12', 'W', 9, 'M', NULL, 2,
            'Ход 1: a5-b6 ---> Ход 2: c7:a5:c3:a1 ---> Ход 3: e5:c7:e9:g7 ---> Ход 4: a1:h8 ---> Ход 5: g5-f6 ---> Ход 6: h8:d4:g1:i3:g5 ---> Ход 7: f4:h6:j8:h10:f8:d6:b4');
-- 6
    INSERT INTO puzzles (board_position, turn_to_move, moves_to_solve, difficulty_level, created_by_player_id, rule_id, solution)
