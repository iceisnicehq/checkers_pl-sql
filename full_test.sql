-- =================================================================
-- ==         ФИНАЛЬНЫЙ ТЕСТОВЫЙ СЦЕНАРИЙ "ОТ СОЗДАНИЯ ДО ХОДОВ"      ==
-- =================================================================
SET SERVEROUTPUT ON;
SET LONG 20000;
SET DEFINE OFF;
...
-- =================================================================
PROMPT --- ЭТАП 0: ПОДГОТОВКА (ОЧИСТКА) ---
PROMPT [ACTION] Подключитесь как владелец схемы C##CHECKERS_APP и выполните этот блок.
...
-- -----------------------------------------------------------------
PROMPT --- ЭТАП 1, ШАГ 1: СОЗДАНИЕ ВЫЗОВА ---
PROMPT [ACTION] Подключитесь как C##DEV_USER и выполните следующий блок.
...
-- -----------------------------------------------------------------
PROMPT --- ЭТАП 1, ШАГ 2: ПРИНЯТИЕ ВЫЗОВА ---
PROMPT [ACTION] Подключитесь как C##DEV2_USER и выполните следующий блок.
...
-- -----------------------------------------------------------------
PROMPT --- ЭТАП 2, ШАГ 2: ХОД ЧЕРНЫХ ---
PROMPT [ACTION] Подключитесь как C##DEV2_USER и выполните следующий блок.
...
PROMPT [SUCCESS] Тестовый сценарий "От Создания до Ходов" завершен.